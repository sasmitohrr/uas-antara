...
import 'dart:io';
import 'package:nsc_hris/camera_page.dart';
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: precenseUser.isEmpty ? Center(child: Text('No data available for today, feel free to clock')) : Expanded(
                            ...
                            Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: NetworkImage(
                                    'http://nscis.nsctechnology.com/' + precenseUser[index]['photo']),
                              ),
                            ),
                            SizedBox(
                              width: 5.0,
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text('Clocking'),
                                Text(precenseUser[index]['time'],style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 18.0,
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text('Date'),
                                Text(precenseUser[index]['date'],style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 18.0,
                                        fontWeight: FontWeight.bold)),
